...
architecture behav of hls_macc is 
    ...
    "hls_macc,hls_ip_2018_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flga2104-2L-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.170000,HLS_SYN_LAT=2,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=289,HLS_SYN_LUT=346}";
    ...
    signal accum_clr_read_reg_84 : STD_LOGIC_VECTOR (0 downto 0);
    signal b_read_reg_89 : STD_LOGIC_VECTOR (31 downto 0);
    signal a_read_reg_94 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal p_acc_reg_load_fu_65_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    accum <= std_logic_vector(unsigned(p_acc_reg_load_fu_65_p3) + unsigned(tmp_1_reg_99));

    accum_ap_vld_assign_proc : process(ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    p_acc_reg_load_fu_65_p3 <= 
        ap_const_lv32_0 when (accum_clr_read_reg_84(0) = '1') else 
        acc_reg;
    tmp_1_fu_57_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(b_read_reg_89) * signed(a_read_reg_94))), 32));
    tmp_2_fu_72_p2 <= std_logic_vector(unsigned(p_acc_reg_load_fu_65_p3) + unsigned(tmp_1_reg_99));
end behav;

...
llvm_cbe_tmp__30:
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([27 x i8]* @aesl_internal_.str3, i64 0, i64 0), i32 %%27) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_100_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__34);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%5, i32* %%accum, align 4, !dbg !4 for 0x%I64xth hint within @ref_macc  --> \n", ++aesl_llvm_cbe_120_count);

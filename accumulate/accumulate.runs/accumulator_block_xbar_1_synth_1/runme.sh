...
HD_PWD='C:/Users/niles/Documents/VivadoProjects/accumulate/accumulate/accumulate.runs/accumulator_block_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accumulator_block_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accumulator_block_xbar_1.tcl

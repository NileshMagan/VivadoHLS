...
HD_PWD='C:/Users/niles/Documents/VivadoProjects/accumulate/accumulate/accumulate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log accumulator_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source accumulator_block_wrapper.tcl -notrace

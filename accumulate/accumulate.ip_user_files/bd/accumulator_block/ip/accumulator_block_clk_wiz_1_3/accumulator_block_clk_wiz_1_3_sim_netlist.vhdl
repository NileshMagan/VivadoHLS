...
--               C:/Users/niles/Documents/VivadoProjects/accumulate/accumulate/accumulate.srcs/sources_1/bd/accumulator_block/ip/accumulator_block_clk_wiz_1_3/accumulator_block_clk_wiz_1_3_sim_netlist.vhdl
...
entity accumulator_block_clk_wiz_1_3_accumulator_block_clk_wiz_1_3_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of accumulator_block_clk_wiz_1_3_accumulator_block_clk_wiz_1_3_clk_wiz : entity is "accumulator_block_clk_wiz_1_3_clk_wiz";
end accumulator_block_clk_wiz_1_3_accumulator_block_clk_wiz_1_3_clk_wiz;

architecture STRUCTURE of accumulator_block_clk_wiz_1_3_accumulator_block_clk_wiz_1_3_clk_wiz is
  signal clk_in1_accumulator_block_clk_wiz_1_3 : STD_LOGIC;
  signal clk_out1_accumulator_block_clk_wiz_1_3 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_accumulator_block_clk_wiz_1_3
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_accumulator_block_clk_wiz_1_3,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_accumulator_block_clk_wiz_1_3,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_accumulator_block_clk_wiz_1_3,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity accumulator_block_clk_wiz_1_3 is
  port (
    clk_out1 : out STD_LOGIC;
    reset : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of accumulator_block_clk_wiz_1_3 : entity is true;
end accumulator_block_clk_wiz_1_3;

architecture STRUCTURE of accumulator_block_clk_wiz_1_3 is
begin
inst: entity work.accumulator_block_clk_wiz_1_3_accumulator_block_clk_wiz_1_3_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
